...
<head>
    ...
    <link rel="icon" href="https://assets.hse.ie/static/hse-frontend/assets/favicons/favicon.ico" type="image/png">
    ...
    <style>
        ...
        #map {
            height: 830px; /* UPDATED: Increased height to match 3 stacked charts on right */
            border-radius: 1rem;
...
def show_dashboard():
    ...
    st.components.v1.html(html_content, height=2700, scrolling=False) 
